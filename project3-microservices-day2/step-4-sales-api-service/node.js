...
// { credentials: credentials, region: "ap-northeast-2" }
// const port = 3000;
    ...
    function (error, results, fields) {
      ...
      if (results[0].stock > 0) {
        ...
        let params = {
          ...
          TopicArn: "arn:aws:sns:ap-northeast-2:307420834314:stock_empty"
        };
...
/**
 curl --location --request POST 'https://me4fxnulhi.execute-api.ap-northeast-2.amazonaws.com/send' \

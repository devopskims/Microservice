...
var params = {
 Attributes: {
  "RedrivePolicy": "{\"deadLetterTargetArn\":\"arn:aws:sqs:ap-northeast-2:307420834314:aws-sqs-dlq-simulation-dev-jobs-dlq\",\"maxReceiveCount\":\"5\"}",
 },
 QueueUrl: "https://sqs.ap-northeast-2.amazonaws.com/307420834314/aws-sqs-dlq-simulation-dev-jobs"
};

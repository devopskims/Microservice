...
export QUEUE_URL=FILL_ME_IN && serverless deploy --aws-profile won --region ap-northeast-2
...
serverless remove --aws-profile FILL_ME_IN --region ap-northeast-2 --stage dev --verbose
